...
class ConversationViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        # Superadmin, manager, staff see all
        if user.role.lower() in ['admin', 'manager', 'staff', 'super_admin']:
    ...
    def messages(self, request, pk=None):
        ...
        if request.method == 'GET':
            ...
            if request.user.role.lower() not in ['admin', 'manager', 'staff', 'super_admin']:
            ...
            if message_type == 'internal_note' and request.user.role.lower() not in ['admin', 'manager', 'staff', 'super_admin']:
