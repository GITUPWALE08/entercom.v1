...
export const TextArea = forwardRef<TextInput, TextAreaProps>(({ label, error, className = '', containerClassName = '', ...props }, ref) => (
  <View className={twMerge("flex-col gap-1.5 w-full", containerClassName)}>
    ...
    <TextInput
      ...
      className={twMerge(
        "w-full px-4 py-3 rounded-xl border bg-gray-50 focus:bg-white text-gray-900 min-h-[100px]",
