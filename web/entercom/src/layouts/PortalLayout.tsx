      ...
      <aside className="w-64 flex-shrink-0 bg-white border-r border-gray-200 hidden md:flex flex-col">
        ...
        <div className="p-4 border-t border-gray-100">
          <div className="flex flex-col gap-2">
            <Link to={`/portal/${user?.role === 'customer' ? 'customer' : 'staff'}/profile`} className="flex items-center px-3 py-2 rounded-lg hover:bg-gray-50 transition-colors group">
              <div className="w-8 h-8 bg-gray-100 rounded-full flex items-center justify-center text-ess-purple font-semibold group-hover:bg-purple-100">
            ...
            <button 
              ...
              className="w-full flex items-center justify-center px-4 py-2 mt-2 border border-red-200 text-sm font-medium rounded-lg text-red-600 bg-red-50 hover:bg-red-100 transition-colors"
            >
              Sign out
            </button>
          </div>
        ...
        >
          ...
          <div className="p-4 border-t border-gray-100">
            <div className="flex items-center px-4 py-3">
              <div className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center text-ess-purple font-semibold">
                {user?.first_name?.charAt(0) || user?.email?.charAt(0)}
              </div>
