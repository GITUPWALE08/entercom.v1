            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="000000"
                  maxLength={6}
                  className="block w-full rounded-md border p-2.5 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 sm:text-sm transition-colors border-gray-300 disabled:bg-gray-100 disabled:text-gray-500 text-center tracking-widest text-lg"
                />
              </div>
            </div>
            <div>
