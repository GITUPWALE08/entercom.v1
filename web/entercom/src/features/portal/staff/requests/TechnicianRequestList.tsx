...
export default function TechnicianRequestList() {
    ...
    <ErrorBoundary>
      <PageContainer>
        <div className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 tracking-tight">Technician Inbox</h1>
            <p className="mt-2 text-gray-500 text-lg">Manage your field operations and assignments.</p>
          </div>
        </div>
        ...
        {isLoading ? (
          ...
          <>
            <DataTable
              ...
              emptyDescription="Your inbox is clear! Good job!"
              columns={[
              {
                header: 'Request ID',
              ...
              },
              {
                ...
                accessor: (req) => (
                  <Link to={`/portal/staff/technician/requests/${req.id}`} className="font-medium text-ess-purple hover:underline">
                    Open Workspace
                  </Link>
                )
              }
